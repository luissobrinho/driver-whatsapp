...
use BotMan\Drivers\WhatsApp\Extensions\Keyboard;
use BotMan\Drivers\WhatsApp\Extensions\KeyboardButton;

class WhatsAppKeyboardTest extends PHPUnit_Framework_TestCase
{
    /** @test */
