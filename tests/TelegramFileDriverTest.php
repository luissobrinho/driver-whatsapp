...
class WhatsAppFileDriverTest extends PHPUnit_Framework_TestCase
{
    private function getDriver($responseData, $htmlInterface = null)
    {
        ...
        return new WhatsAppFileDriver($request, [], $htmlInterface);
    }
    ...
    public function it_returns_the_driver_name()
    {
        ...
        $this->assertSame('WhatsAppFile', $driver->getName());
    }
