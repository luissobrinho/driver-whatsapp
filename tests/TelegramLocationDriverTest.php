...
class WhatsAppLocationDriverTest extends PHPUnit_Framework_TestCase
{
    private function getDriver($responseData, $htmlInterface = null)
    {
        ...
        return new WhatsAppLocationDriver($request, [], $htmlInterface);
    }
    ...
    public function it_returns_the_driver_name()
    {
        ...
        $this->assertSame('WhatsAppLocation', $driver->getName());
    }
