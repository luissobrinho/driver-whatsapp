...
class WhatsAppPhotoDriverTest extends PHPUnit_Framework_TestCase
{
    private function getDriver($responseData, $htmlInterface = null)
    {
        ...
        return new WhatsAppPhotoDriver($request, [], $htmlInterface);
    }
    ...
    public function it_returns_the_driver_name()
    {
        ...
        $this->assertSame('WhatsAppPhoto', $driver->getName());
    }
