...
class WhatsAppDriverTest extends PHPUnit_Framework_TestCase
{
    ...
    private function getDriver($responseData, $htmlInterface = null)
    {
        ...
        return new WhatsAppDriver($request, [], $htmlInterface);
    }
    ...
    public function it_calls_telegram_login_event()
    {
        ...
        $driver = new WhatsAppDriver($request, [
            'telegram' => [
                'token' => $token,
            ],
        ], m::mock(Curl::class));
        ...
        $event = $driver->hasMatchingEvent();
        $this->assertInstanceOf(GenericEvent::class, $event);
        $this->assertSame(WhatsAppDriver::LOGIN_EVENT, $event->getName());
    ...
    public function it_returns_answer_from_interactive_messages()
    {
        ...
        $driver = new WhatsAppDriver($request, $this->telegramConfig, $html);
    ...
    public function it_does_not_hide_keyboard_if_configured()
    {
        ...
        $driver = new WhatsAppDriver($request, $telegramConfig, $html);
    ...
    public function it_can_reply_with_default_additional_parameters()
    {
        ...
        $driver = new WhatsAppDriver($request, $this->telegramConfigWithDefaultAdditionalParameters, $html);
    ...
    public function it_is_configured()
    {
        ...
        $driver = new WhatsAppDriver($request, $this->telegramConfig, $htmlInterface);
        ...
        $driver = new WhatsAppDriver($request, [], $htmlInterface);
    ...
    "description": "Bad Request: can\'t parse entities: Can\'t find end of Italic entity at byte offset 10"
        ...
        $driver = new WhatsAppDriver($request, $configurationWithHttpExceptions, $htmlInterface);
        ...
        $this->assertSame(WhatsAppConnectionException::class, get_class($throwable));
...
END:VCARD';
    ...
    public function it_throws_exception_in_get_user()
    {
        ...
        $this->assertNotNull($throwable);
        $this->assertSame(WhatsAppException::class, get_class($throwable));
    }
